function modIn() {
    ...
    $('#d_grado').html("<select class=\"form-control\" name = \"new_rank\"> <option disable value=\"\"> </option> <option value=\"scuola\"> Scuola </option> <option value=\"università\"> Università </option> <option value=\"altro\"> Altro </option> </select>");
