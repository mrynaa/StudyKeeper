...
<?php 
    ...
    if(isset($_SESSION["canc_confirm"])) {
      echo "<script> alert(\"Cancellazione effettuata\"); </script>";
      unset($_SESSION["canc_confirm"]);
    } 
  ?> 
  ...
  <!-- CENTRO DELLA PAGINA -->
  <form id="pswform" action="reg.php" class="ui-form" method="post">
    <h1 class="welcome">Unisciti alla community!</h1>
     <div class="form-row">
        <input type="text" name="username" size ="30" minlength="3" maxlength="30" required autofocus>
    ...
    <div class="form-row">
      <input type="password" id="psw" name="password" size="30" minlength="8" maxlength="30" required>
      <label for="password">Password</label>
      <span id="err1" style="color: red;">  </span>
    </div>
    <div class="form-row">
        <input type="password" id="cpsw" name="conferma_password"  minlength="8" size="30" minlength="3" maxlength="30" required>
    ...
    <p></p>
    <div> 
      Possiedi già un account? <a href="login.php">Accedi</a>
    </div>
  </form>
